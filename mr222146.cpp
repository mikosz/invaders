...
//                {
//                    for(size_t j = 0; j < gameState.alphaProximity.size(); ++j)
//                    {
//                        if(gameState.alphaProximity[i][j] == std::numeric_limits<size_t>::max())
//                            std::cerr << "_ ";
//                        else if(gameState.alphaProximity[i][j] >= 10)
//                            std::cerr << "> ";
//                        else
//                            std::cerr << gameState.alphaProximity[i][j] << " ";
//                    }
//                    std::cerr << std::endl;
//                }
...
//                {
//                    for(size_t j = 0; j < gameState.numProximity.size(); ++j)
//                    {
//                        if(gameState.numProximity[i][j] == std::numeric_limits<size_t>::max())
//                            std::cerr << "_ ";
//                        else if(gameState.numProximity[i][j] >= 10)
//                            std::cerr << "> ";
//                        else
//                            std::cerr << gameState.numProximity[i][j] << " ";
//                    }
//                    std::cerr << std::endl;
//                }
//            }
